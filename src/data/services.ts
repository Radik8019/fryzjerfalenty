...
export const services: Service[] = [
  {
    id: 'ladies-cut-style',
    group: 'ladies',
    name: { pl: 'Strzyżenia i stylizacje', en: 'Cuts & styling' },
  ...
  },
  {
    ...
    detail: { pl: 'Cięcie i forma skrętu', en: 'Cut and curl form' },
    price: pending,
  },
  {
    id: 'ladies-global',
    group: 'ladies',
    name: { pl: 'Koloryzacje globalne', en: 'Global colour' },
  ...
  },
  {
    ...
    group: 'ladies',
    name: { pl: 'Dekoloryzacja + tonowanie', en: 'Decolouring + toning' },
    detail: { pl: 'Koloryzacja', en: 'Colour' },
    price: pending,
  },
  {
  ...
  },
  {
    ...
    group: 'gentlemen',
    name: { pl: 'Tonowanie — lekki cover', en: 'Toning — light cover' },
    detail: { pl: 'Kolor', en: 'Colour' },
    price: pending,
  },
  {
    ...
    group: 'gentlemen',
    name: { pl: 'Tonowanie — pełny cover', en: 'Toning — full cover' },
    detail: { pl: 'Kolor', en: 'Colour' },
    price: pending,
  },
  {
